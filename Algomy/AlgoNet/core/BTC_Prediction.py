...
def btc_prediction():
    today = date.today()
    df = yf.download("BTC-USD", start = "2019-9-18", end = today )
    df.to_csv('/home/archie/Neural_Networks/BTC-USD.csv')
    auto("/home/archie/Neural_Networks/BTC-USD.csv")
    df = pd.read_csv("/home/archie/Neural_Networks/BTC-USD.csv")
    ...
    print("Bitcoin Prediction RMSE: ", pred_actual_rmse)
